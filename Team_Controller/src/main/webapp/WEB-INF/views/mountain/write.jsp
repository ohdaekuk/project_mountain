...
<body>
	...
	<form class="write_form" action="forum_write" method="POST"
		...
		<div class="main_text_div">
			<p>내용</p>
			<textarea name="content" cols="30" rows="10" style="resize: none; height: 250px;" placeholder="글쓰기 내용"></textarea>
		</div>

		<div class="button">
			<input name="image" type="file" value=""> <input type="submit" class="btn-secondary btn-sm" value="글쓰기">
		</div>
	</form>
